...
!(function () {
    ...
    isDarkStyle
        ...
        : ((e = config.colors.cardColor),
          ...
          (a = config.colors_label.secondary));
    const l = { series1: "#826af9", series2: "#d2b0ff", bg: "#f8d3ff" },
        i = {
            series1: "#fee802",
            series2: "#3fd0bd",
            series3: "#826bf8",
    ...
    const compareGraphFollower = document.querySelector(
            "#compareGraphFollower"
        ),
        followerCompare = {
            chart: {
                height: 400,
    ...
    if (
        void 0 !== typeof compareGraphFollower &&
        null !== compareGraphFollower
    ) {
        new ApexCharts(compareGraphFollower, followerCompare).render();
    }

    const compareGraphLike = document.querySelector("#compareGraphLike"),
        likeCompare = {
            chart: {
                height: 400,
                fontFamily: "IBM Plex Sans",
    ...
    if (void 0 !== typeof compareGraphLike && null !== compareGraphLike) {
        new ApexCharts(compareGraphLike, likeCompare).render();
    }

    const compareGraphView = document.querySelector("#compareGraphView"),
        viewCompare = {
            chart: {
                height: 400,
                fontFamily: "IBM Plex Sans",
    ...
    if (void 0 !== typeof compareGraphView && null !== compareGraphView) {
        new ApexCharts(compareGraphView, viewCompare).render();
    }

    const compareGraphEngagement = document.querySelector(
            "#compareGraphEngagement"
        ),
        engagementCompare = {
            chart: {
                height: 400,
    ...
    if (
        void 0 !== typeof compareGraphEngagement &&
        null !== compareGraphEngagement
    ) {
        new ApexCharts(compareGraphEngagement, engagementCompare).render();
    }

    const p = document.querySelector("#barChart"),
        f = {
            chart: {
                height: 400,
                fontFamily: "IBM Plex Sans",
    ...
    if (void 0 !== typeof p && null !== p) {
        new ApexCharts(p, f).render();
    }
    const x = document.querySelector("#scatterChart"),
        m = {
            chart: {
                height: 400,
                fontFamily: "IBM Plex Sans",
    ...
    if (void 0 !== typeof x && null !== x) {
        new ApexCharts(x, m).render();
    }
    const g = document.querySelector("#lineChart"),
        b = {
            chart: {
                height: 400,
                fontFamily: "IBM Plex Sans",
    ...
    if (void 0 !== typeof g && null !== g) {
        new ApexCharts(g, b).render();
    }
    const y = document.querySelector("#horizontalBarChart"),
        u = {
            chart: {
                height: 400,
                fontFamily: "IBM Plex Sans",
    ...
    if (void 0 !== typeof y && null !== y) {
        new ApexCharts(y, u).render();
    }
    const w = document.querySelector("#candleStickChart"),
        S = {
            chart: {
                height: 410,
                fontFamily: "IBM Plex Sans",
    ...
    if (void 0 !== typeof w && null !== w) {
        new ApexCharts(w, S).render();
    }
    const C = document.querySelector("#heatMapChart"),
        k = {
            chart: {
                height: 350,
                fontFamily: "IBM Plex Sans",
    ...
    if (void 0 !== typeof C && null !== C) {
        new ApexCharts(C, k).render();
    }
    const z = document.querySelector("#radialBarChart"),
        B = {
            chart: {
                height: 380,
                fontFamily: "IBM Plex Sans",
            ...
            plotOptions: {
                radialBar: {
                    size: 185,
                    hollow: { size: "40%" },
                    track: { margin: 10, background: a },
                    dataLabels: {
                        name: { fontSize: "2rem", fontFamily: "IBM Plex Sans" },
                        value: {
                            fontSize: "1.2rem",
                            color: t,
                            fontFamily: "IBM Plex Sans",
    ...
    if (void 0 !== typeof z && null !== z) {
        new ApexCharts(z, B).render();
    }
    const M = document.querySelector("#radarChart"),
        A = {
            chart: {
                height: 350,
                fontFamily: "IBM Plex Sans",
    ...
    const F = document.querySelector("#donutChart"),
        O = {
